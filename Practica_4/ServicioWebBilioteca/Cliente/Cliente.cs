using Cliente.ServicioBiblioteca;
using System;
...
namespace Cliente
{
    class Cliente
    {
        ...
        private void ObtenerListaRepositorios(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca, bool flag)
        {
        ...
        private int FuncConexion(String contraseña, ServicioBiblioteca.GestorBibliotecaClient gestorBilioteca)
        {
        ...
        private bool FuncDesconexion(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBilioteca)
        {
        ...
        private int FuncAbrirRepositorio(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBilioteca, String nombreRepositorio)
        {
        ...
        private int FuncNLibros(int pRepo, ServicioBiblioteca.GestorBibliotecaClient gestorBilioteca)
        {
        ...
        private TLibro FuncDescargar(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBilioteca, int pRepo, int pPos)
        {
        ...
        private bool FuncOrdenar(int pIda, ServicioBiblioteca.GestorBibliotecaClient gestorBilioteca, int pCampo)
        {
        ...
        private int FuncGuardarRepositorio(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBilioteca, int pRepos)
        {
        ...
        private int FuncNRepositorios(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBilioteca)
        {
            try
            {
        ...
        private TDatosRepositorio FuncDatosRepositorio(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBilioteca, int pRepos)
        {
        ...
        private int FuncNuevoLibro(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca, TLibro libro, int pRepos)
        {
        ...
        private int FuncBuscar(int pIda, ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca, String pIsbn)
        {
        ...
        private int FuncComprar(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca, String pIsbn, int pNoLibros)
        {
        ...
        private int FuncRetirar(int pIda, ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca, String pIsbn, int pNoLibros)
        {
        ...
        private bool FiltrarLibros(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca, bool admin)
        {
        ...
        private int FuncPrestar(int pPos, ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca)
        {
        ...
        private int FuncDevolver(int pPos, ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca)
        {

            try
            {
                return gestorBiblioteca.Devolver(pPos);

            }
            catch (Exception)
            {
                Console.WriteLine("Se ha producido un error en la funcion devolver");
            }
            return -3;
        }

        private void GestionAdministracion(int ida, ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca)
        {
        ...
        private void GestionPrincipal(ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca)
        {
        ...
        static void Main(string[] args)
        {
            ...
            ServicioBiblioteca.GestorBibliotecaClient gestorBiblioteca = new ServicioBiblioteca.GestorBibliotecaClient();
